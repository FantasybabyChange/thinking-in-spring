...
/**
 * customer {@link Qualifier} to group the bean
 * <p>
 * <p>
 ...
 * @author Fantasy Baby
 */
public class CustomerAnnotationNameInjectDemo {
    @Resource
    @Qualifier("user1")
    ...
    public static void main(String[] args) {
        ...
        annotationConfigApplicationContext.register(CustomerAnnotationNameInjectDemo.class);
        ...
        CustomerAnnotationNameInjectDemo bean = annotationConfigApplicationContext.getBean(CustomerAnnotationNameInjectDemo.class);
